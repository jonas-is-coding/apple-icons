...
const SvgCartopdoorfrontleftandfrontrightandrearleftandrearrightopenfillBold =
  ({ title, titleId, ...props }) => (
    <svg
...
export default SvgCartopdoorfrontleftandfrontrightandrearleftandrearrightopenfillBold;
